...
//
//
//  class AddAskContext[M[_]](implicit C:Context[M, EventLog, Throwable, Failure]) {
...
//  }
//
//  class AddStateContext[M[_]:MonadError[*[_], Throwable]:LiftIO](implicit C:Context[M, EventLog, Throwable, Failure]) {
//    import EnvironmentLift._
//
//    implicit val e: EnvironmentContext[M, Failure, EventLog, Throwable, String] = C.apply[String]
