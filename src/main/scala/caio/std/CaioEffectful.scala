...
class CaioEffectful[C, V, L:Monoid](
                                     ...
                                     base:ConcurrentEffect[Caio[Unit, V, L, *]]) extends Effectful[Caio[C, V, L, *]]{
  def concurrentEffect: Caio[C, V, L, ConcurrentEffect[Caio[C, V, L, *]]] =
    applicativeAsk.ask.map{c =>
      ...
      new ConcurrentEffectIsomorphism[Caio[C, V, L, *],Caio[Unit, V, L, *]](base, iso)(base.asInstanceOf[Concurrent[Caio[C, V, L, *]]])
    }
